...
export interface ApplicationCommand {
  ...
  readonly contexts?: InteractionContextType[] | null;
...
export interface BulkBanResponse {
  ...
  readonly banned_users: Snowflake[];
  /** list of user ids, that were not banned */
  readonly failed_users: Snowflake[];
}
...
The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id. */
  ...
  createTestEntitlement: (applicationId: string, options?: O) => Promise<any>;
...
The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id. */
  ...
  getAnswerVoters: (
    ...
    options?: O,
  ) => Promise<GetAnswerVoterResponse>;
  ...
  getCurrentApplication: (options?: O) => Promise<Application>;
  ...
  getCurrentUserConnections: (options?: O) => Promise<Connection[]>;
...
The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id. */
  ...
  listEntitlements: (applicationId: string, options?: O) => Promise<any>;
  ...
  listSkUs: (applicationId: string, options?: O) => Promise<any>;
  /** Returns a list of available sticker packs. */
  listStickerPacks: (options?: O) => Promise<any>;
  listThreadMembers: (
    channelId: string,
...
export interface PollResult {
  ...
  readonly answer_counts: PollAnswerCount[];
}
...
export interface SelectMenu {
  ...
  readonly default_values?: SelectDefaultValue[];
